  ...
  return (
    <>
      <section style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="nv-wrap" style={{ position: "relative", padding: "clamp(3rem, 8vw, 5rem) 0 2rem", maxWidth: 820 }}>
          <Reveal>
      ...
      <section style={{ paddingTop: "1rem" }}>
        <div className="nv-wrap">
          <Reveal>
            ...
            >
              <div style={{ padding: "clamp(1.35rem, 4vw, 3.2rem)", minWidth: 0 }}>
                <span className="nv-eyebrow">{featured.kicker} {"·"} Featured</span>
                <h2 style={{ fontSize: "clamp(1.45rem, 3.5vw, 2.6rem)", marginTop: "1rem" }}>{featured.title}</h2>
                <p className="nv-muted" style={{ marginTop: "1rem", fontSize: "clamp(1rem, 2.6vw, 1.1rem)", lineHeight: 1.6 }}>
                  {featured.body}
                </p>
            ...
            {rest.map((r, i) => (
              <Reveal key={r.title} delay={i * 0.06}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: "clamp(1.15rem, 3.5vw, 1.35rem)", marginTop: "0.9rem" }}>{r.title}</h3>
